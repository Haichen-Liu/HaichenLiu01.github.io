...
Below are examples of visual anagrams I generated locally. The images in the first row represent the **Identity View**, while the second row reveals the hidden semantics upon **Transformation** (e.g., rotation or permutation).

| **Experiment A** | **Experiment B** |
| :---: | :---: |
| <img src="/assets/images/6.png" width="100%"> | <img src="/assets/images/7.png" width="100%"> |
| *Identity View (Original)* | *Identity View (Original)* |
| <img src="/assets/images/6I.png" width="100%"> | <img src="/assets/images/7I.png" width="100%"> |
